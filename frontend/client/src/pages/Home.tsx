...
import { Day, ForecastRecord, Roles } from '../types/types';
import { OtherCities, PortugueseCities } from '../constants';
import { DatePicker } from '@mui/x-date-pickers';
import dayjs, { Dayjs } from 'dayjs';

const FREE_MIN = '2023-11-24';
const FREE_MAX = '2023-11-27';
...
export default function Home() {
    ...
    const [endDate, setEndDate] = useState<Dayjs | null>(dayjs('2023-11-27'));
        ...
        const getWeather = async () => {
            ...
            const URL =
                currentUser.user.role === Roles.FREE
                    ? `https://localhost:5001/forecast/${selectedCity}/`
                    : `https://localhost:5001/forecast/${selectedCity}/${start}/${end}`;
            await apiInstance
                .get(URL)
    ...
    //     if (date === 'start') {
    //         if (value.isBefore('2023-11-24') || value.isAfter('2023-12-03')) {
    //             // error
    //             console.log('Err');
    //         } else {
    //             if (
    //                 value.diff(endDate, 'day') > 3 &&
    //                 currentUser.user.role === Roles.FREE
    //             ) {
    //                 // Can only see up to 4 days
    //                 console.log('Up to 4 days because of role (start)');
    //             } else if (value.diff(endDate, 'day') > 10) {
    //                 // Can only see max 10 days
    //                 console.log('Up to 10 days (start)');
    //             } else {
    //                 setStartDate(value);
    //             }
    //         }
    ...
    //         } else {
    //             if (
    //                 value.diff(startDate, 'day') > 3 &&
    //                 currentUser.user.role === Roles.FREE
    //             ) {
    //                 // Can only see up to 4 days
    //                 console.log('Up to 4 days because of role (start)');
    //             } else if (value.diff(startDate, 'day') > 10) {
    //                 // Can only see max 10 days from 24/11
    //                 console.log('Up to 10 days (start)');
    //             } else {
    //                 setEndDate(value);
    //             }
